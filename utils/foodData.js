...
const foodData = {
    ...
    3: [
        ...
        { id: 13, name: '烤串拼盘', image: 'https://images.unsplash.com/photo-155593959458d7cb561ad1?w=400&h=400&fit=crop', price: 38, desc: '多种烤串组合', sales: 1567, video: 'https://www.w3schools.com/html/mov_bbb.mp4', detail: '精选羊肉串、牛肉串、鸡翅、蔬菜串等多种烤串组合，炭火烤制，撒上孜然辣椒，香气扑鼻。' },
